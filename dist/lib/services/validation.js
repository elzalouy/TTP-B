...
exports.createTaskSchema = joi_1.default.object({
    ...
    status: joi_1.default.string().valid("Tasks Board", "In Progress").required().messages({
    ...
    teamListId: joi_1.default.string().optional().allow(null),
});
exports.editTaskSchema = joi_1.default.object({
    ...
    status: joi_1.default.string()
        .valid("Tasks Board", "In Progress", "Review", "Cancled", "Done", "Late", "Shared", "Not Clear")
        .optional(),
    deadline: joi_1.default.date().optional().allow(null, ""),
