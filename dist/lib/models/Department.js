...
const listSchema = joi_1.default
  .array()
  .required()
  .min(7)
  .items({
...
const createDepartmentValidationSchema = joi_1.default
  .object({
    _id: joi_1.default.object().optional(),
    name: joi_1.default
      .string()
...
const updateDepartmentValidateSchema = (teams) =>
...
DepartmentSchema.methods.createDepartmentBoard = function () {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      let teams = lodash_1.default.uniqBy([...this.teams], "name"),
        lists = [...this.lists],
        board,
        result;
      // 1- create board
      ...
      if (
        (board === null || board === void 0 ? void 0 : board.id) &&
        (board === null || board === void 0 ? void 0 : board.url)
      ) {
      ...
      //2- create lists
      let departmentLists =
        this.name.toLowerCase() === config_1.default.get("CreativeBoard")
          ? [...lists, { name: "projects", listId: "" }]
          : lists;
      let listsResult = yield departmentLists.map((list, index) =>
      ...
      if (CreativeBoard)
        trello_1.default.createWebHook(
          CreativeBoard.listId,
          "trelloWebhookUrlProject"
        );
      // 3- create teams
      let teamsResult = yield teams.map((team, index) =>
        __awaiter(this, void 0, void 0, function* () {
...
DepartmentSchema.methods.updateTeams = function (data, cb) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      let depTeams = [];
      // remove teams
      yield data.removeTeams.forEach((item, index) =>
        __awaiter(this, void 0, void 0, function* () {
      ...
      depTeams = yield Promise.all(
        data.addTeams.map((item) =>
          __awaiter(this, void 0, void 0, function* () {
            let list = yield trello_1.default.addListToBoard(
              this.boardId,
              item
            );
