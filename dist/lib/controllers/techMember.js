...
const techMember_1 = __importDefault(
  require("../dbCalls/techMember/techMember")
);
const errorUtils_1 = require("../utils/errorUtils");
const trello_1 = __importDefault(require("./trello"));
const department_1 = __importDefault(
  require("../dbCalls/department/department")
);
const TechMemberController = class TechMemberController extends techMember_1.default {
  ...
  static deleteTechMemberWhere(data) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield TechMemberController.__deleteTechMember(data);
    });
  }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (boardId === newBoardId) {
          yield TechMemberController.__removeMemberAndList(
            listId,
            boardId,
            trelloMemberId
          );
        ...
        if (newBoardId && newBoardId !== boardId) {
          let checkExsit = yield TechMemberController.__checkBoardListName(
            newBoardId,
            name
          );
          ...
          yield trello_1.default.addMemberToBoard(
            newBoardId,
            trelloMemberId,
            "normal"
          );
  ...
  static __createMember(data) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        let techMember = yield _super.createTechMember.call(
          this,
          Object.assign(Object.assign({}, data), {
            listId: listId === null || listId === void 0 ? void 0 : listId.id,
          })
        );
  ...
  static __checkBoardListName(boardId, name) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let check = false;
        // Get Lists in Board
        let boardList = yield trello_1.default.getSingleBoardInfo(
          boardId,
          "lists"
        );
  ...
  static __deleteTechMember(data) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        return yield TechMemberController.deleteTechMemberDB(data);
      } catch (error) {
        logger_1.default.error({ __deleteTechMemberError: error });
      }
    });
  }
};
