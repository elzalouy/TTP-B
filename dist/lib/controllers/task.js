...
class TaskController extends tasks_1.default {
  ...
  static moveTaskOnTrello(cardId, listId, status, list, user) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield TaskController.__moveTaskOnTrello(
        cardId,
        listId,
        status,
        list,
  ...
  static __moveTaskOnTrello(cardId, listId, status, list, user) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        (0, task_actions_Queue_1.moveTaskJob)(listId, cardId, status, user);
  ...
  static __updateTaskData(data, files) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        if (!data.cardId) return Tasks_1.provideCardIdError;
        // recieve data
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        if (files && files.length > 0) {
          let newAttachments = yield files.map((file) =>
            __awaiter(this, void 0, void 0, function* () {
              return yield trello_1.default.createAttachmentOnCard(
                data.cardId,
                file
              );
            })
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (createdCard) {
          ...
          if (task) {
            tasks_Route_Queue_1.taskRoutesQueue.push(() =>
              __awaiter(this, void 0, void 0, function* () {
                data.cardId = createdCard.id;
                data.trelloShortUrl = createdCard.shortUrl;
                yield trello_1.default.createWebHook(
                  data.cardId,
                  "trelloWebhookUrlTask"
                );
                if (files.length > 0)
                  data = yield TaskController.__createTaskAttachment(
                    files,
                    data
                  );
              })
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (task) {
          ...
          yield trello_1.default.deleteCard(
            task === null || task === void 0 ? void 0 : task.cardId
          );
  ...
  static __downloadAttachment(cardId, attachmentId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let response = yield trello_1.default.downloadAttachment(
          cardId,
          attachmentId
        );
        return response;
  ...
  static __editTasksProjectId(ids, projectId) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let result = yield _super.__updateTasksProjectId.call(
          this,
          projectId,
          ids
        );
