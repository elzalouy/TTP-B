...
const boardQueue_1 = require("../backgroundJobs/boardQueue");
(0, dotenv_1.config)();
var FormData = require("form-data");
class BoardController {
  static getBoardsInTrello() {
    return __awaiter(this, void 0, void 0, function* () {
      return yield TrelloController.__getTrelloBoards();
    });
  }
  static getSingleBoardInfo(id, type) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield TrelloController.__singleBoardInfo(id, type);
    });
  }
  ...
  static createCardInList(listId, cardName, description) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield TrelloController.__createCard(listId, cardName, description);
    });
  }
  ...
  static moveTaskToDiffList(cardId, listId) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield TrelloController.__moveTaskToDiffList(cardId, listId);
    });
  }
  static updateBoardCard(data) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield TrelloController.__updateBoardCard(data);
    });
  }
  static webhookUpdate(data) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield TrelloController.__webhookUpdate(data);
    });
  }
  static __webhookUpdate(data) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        yield TrelloController.updateBoardCard(data);
      } catch (error) {
  ...
  static __moveTaskToDiffList(cardId, listId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let moveTask = (0, trelloApi_1.trelloApi)(
  ...
  static __deleteBoard(id) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let removeBoard = (0, trelloApi_1.trelloApi)(
          `boards/${id}?response_type=token&`
        );
  ...
  static __updateBoard(id, values) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        let updateBoardApi = (0, trelloApi_1.trelloApi)(
  ...
  static __createNewBoard(name, color) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let createBoardApi = (0, trelloApi_1.trelloApi)(
  ...
  static __createAttachment(cardId, file) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        let endpoint = (0, trelloApi_1.trelloApi)(
  ...
  static __createCard(listId, cardName, description) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let cardCreateApi = (0, trelloApi_1.trelloApi)(
  ...
  static __getCardAttachments(cardId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        let Response;
        yield (0, node_fetch_1.default)(api).then((data) =>
          __awaiter(this, void 0, void 0, function* () {
  ...
  static __addWebHook(idModel, urlInConfig) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let webhookUrl = `webhooks/?callbackURL=${config_1.default.get(
          urlInConfig
        )}&idModel=${idModel}&`;
        ...
        logger_1.default.info({ webhookResult: yield webhookResult.json() });
  ...
  static __archieveList(listId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let archeiveApi = (0, trelloApi_1.trelloApi)(
  ...
  static __removeMember(boardId, memberId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let removeApi = (0, trelloApi_1.trelloApi)(
  ...
  static __addList(boardId, listName) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let addListApi = (0, trelloApi_1.trelloApi)(
          `lists?name=${listName}&idBoard=${boardId}&`
        );
  ...
  static __addMember(boardId, memberId, type) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let addMemberApi = (0, trelloApi_1.trelloApi)(
  ...
  static __getAllMembers() {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let boardApi = (0, trelloApi_1.trelloApi)(
  ...
  static __getTrelloBoards() {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let boardsApi = (0, trelloApi_1.trelloApi)(
  ...
  static __downloadAttachment(cardId, attachmentId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let api = (0, trelloApi_1.trelloApi)(
  ...
  static __updateBoardCard(data) {
    return __awaiter(this, void 0, void 0, function* () {
      boardQueue_1.TrelloCardActionsQueue.push((cb) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
          try {
            let type =
              (_a = data.action) === null || _a === void 0 ? void 0 : _a.type;
            let action = (
              (_c =
                (_b =
            ...
            let task = {
              ...
              cardId:
                (_f = data.action.data.card) === null || _f === void 0
                  ? void 0
                  : _f.id,
            };
            ...
            if (
              ...
              // update task
              yield task_1.default.updateTaskByTrelloDB(task);
            }
            if (
              type === "updateCard" &&
            ...
            if (type === "addAttachmentToCard") {
              task.attachedFile = {
                trelloId:
                  (_j =
                    (_h = data.action.data) === null || _h === void 0
                      ? void 0
                      : _h.attachment) === null || _j === void 0
                    ? void 0
                    : _j.id,
                name:
                  (_l =
                    (_k = data.action.data) === null || _k === void 0
                      ? void 0
                      : _k.attachment) === null || _l === void 0
                    ? void 0
                    : _l.name,
                url:
                  (_m = data.action.data.attachment) === null || _m === void 0
                    ? void 0
                    : _m.url,
                // utils function to detect type from name.ext
                mimeType: (0, validation_1.validateExtentions)(
                  (_p =
                    (_o = data.action.data) === null || _o === void 0
                      ? void 0
                      : _o.attachment) === null || _p === void 0
                    ? void 0
                    : _p.name
                ),
              };
            ...
            if (type === "updateCard" && action === "action_archived_card") {
              ...
              let result = yield task_1.default.archiveTaskByTrelloDB(
                task,
                true
              );
            }
            if (
              ...
              yield task_1.default.archiveTaskByTrelloDB(task, false);
            }
            //delete
            if (type === "deleteCard") {
  ...
  static webhookUpdateBoard(data) {
    return __awaiter(this, void 0, void 0, function* () {
      boardQueue_1.TrelloCardActionsQueue.push((cb) =>
        __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            if (type === "createCard" && action === "action_create_card") {
              ...
              if (dep) {
                ...
                yield task_1.default.createTaskByTrello(task);
              }
            }
            cb();
          } catch (error) {
