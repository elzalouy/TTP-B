...
class TrelloController {
  ...
  static moveTaskToDiffList(cardId, listId, due) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield TrelloController.__moveTaskToDiffList(
        cardId,
        listId,
        due !== null && due !== void 0 ? due : undefined
      );
    });
  }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let createBoardApi = (0, trelloApi_1.trelloApi)(
          `boards/?name=${name}&prefs_background=${color}&defaultLists=false&idOrganization=${config_1.default.get(
            "trelloOrgId"
          )}&`
        );
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let url = `cards/?idList=${
          (_a = data.teamListId) !== null && _a !== void 0 ? _a : data.listId
  ...
  static __addWebHook(idModel, urlInConfig) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let route = "webhooks";
        let params = `idModel=${idModel}&callbackURL=${config_1.default.get(
          urlInConfig
        )}`;
  ...
  static __getAllWebWebHook(idModel, urlInConfig) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let webhookUrl = `webhooks/?idModel=${idModel}&callbackURL=${config_1.default.get(
          urlInConfig
        )}&`;
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let boardApi = (0, trelloApi_1.trelloApi)(
          `organizations/${config_1.default.get(
            "trelloOrgId"
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        yield (0, node_fetch_1.default)(api, {
          ...
          headers: {
            Accept: "application/json",
            Authorization: `OAuth oauth_consumer_key=${config_1.default.get(
              "trelloKey"
            )}, oauth_token=${config_1.default.get("trelloToken")}`,
          },
        }).then((response) =>
          __awaiter(this, void 0, void 0, function* () {
