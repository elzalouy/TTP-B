...
router.post(`${CREATE_CATEGORY}`, Authed_1.default, SM_1.default, handleCreateCategory);
router.put(`${UPDATE_CATEGORY}`, Authed_1.default, SM_1.default, handleUpdateCategory);
router.get(`${GET_CATEGORYS}`, Authed_1.default, handleGetCategories);
router.delete(`${DELETE_CATEGORY}`, Authed_1.default, SM_1.default, handleDeleteCategory);
