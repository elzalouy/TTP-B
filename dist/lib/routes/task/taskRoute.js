...
const { CREATE_TASK, UPDATE_TASK, WEBHOOK_UPDATES, GET_TASKS, FILTER_TASKS, MOVE_TASK, DELETE_TASKS, DELETE_TASKS_BY_PROJECT_ID, DELETE_TASK, GET_TASKS_STATISTICS, GET_ALL_TASKS_STATISTICS, DOWNLOAD_ATTACHMENT, } = apis_1.default;
const { handleCreateCard, handleUpdateCard, handleWebhookUpdateCard, handleGetTasks, handleFilterTasks, handleMoveCard, handleDeleteTasks, handleDeleteTasksByProjectId, handleDeleteTask, handleDownloadAttachment, } = task_1.default;
