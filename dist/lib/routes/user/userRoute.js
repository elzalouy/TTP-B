...
const { CREATE_USER, UPDATE_USER, UPDATE_PASSWORD, DELETE_USER, GET_USERS, GET_USER, RESET_PASSWORD, RESEND_MAIL } = apis_1.default;
const { handleCreatUser, handleUpdateUser, handleUpdatePassword, handleDeleteUser, handleGetUserPmOrSA, handleGetUserInfo, handleResetPassword, handleResendMail } = users_1.default;
