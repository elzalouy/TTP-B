...
const { CREATE_USER, UPDATE_USER, UPDATE_PASSWORD, DELETE_USER, GET_USERS, GET_USER } = apis_1.default;
const { handleCreatUser, handleUpdateUser, handleUpdatePassword, handleDeleteUser, handleGetUserPmOrSA, handleGetUserInfo } = users_1.default;
