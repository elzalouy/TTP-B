  ...
  return new cron_1.CronJob(
    ...
    () =>
      __awaiter(this, void 0, void 0, function* () {
        let today = new Date();
        let dueDateProjects = yield Project_1.default
          .find()
          .where("projectStatus")
          ...
          dueDateProjects.forEach((item) =>
            __awaiter(this, void 0, void 0, function* () {
              yield notification_1.default.__createNotification({
                ...
                isNotified: [
                  { userId: item.projectManager, isNotified: false },
                ],
              });
            })
          );
          let ids = dueDateProjects.map((item) =>
            item.projectManager.toString()
          );
          let sockets = socket_1.socketPMs.filter((item) =>
...
function projectsPassedDate(io) {
  return new cron_1.CronJob(
    ...
    () =>
      __awaiter(this, void 0, void 0, function* () {
        let passedDatesPojects = yield Project_1.default
          .find({
        ...
        if (passedDatesPojects.length > 0) {
          passedDatesPojects.forEach((item) =>
            __awaiter(this, void 0, void 0, function* () {
              yield notification_1.default.__createNotification({
              ...
              let ids = passedDatesPojects.map((item) =>
                item.projectManager.toString()
              );
              let sockets = socket_1.socketPMs.filter((item) =>
                ids.includes(item.id)
