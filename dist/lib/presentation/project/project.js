    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (!projectData) {
          return res
            .status(400)
            .send((0, errorUtils_1.customeError)("project_missing_data", 400));
        }
        let project = yield _super.createProject.call(
          this,
          projectData,
          (_a =
        ...
        if (project) {
          ...
          return res
            .status(400)
            .send((0, errorUtils_1.customeError)("create_project_error", 400));
        }
      } catch (error) {
        logger_1.default.error({ handleCreateProjectErrors: error });
        return res
          .status(500)
          .send((0, errorUtils_1.customeError)("server_error", 500));
      }
    });
  }
  static handleUpdateProject(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        let project = yield _super.updateProject.call(
          this,
          projectData,
          decoded.user.id
        );
        if (project) {
          ...
          return res
            .status(400)
            .send((0, errorUtils_1.customeError)("update_project_error", 400));
        }
      } catch (error) {
  ...
  static handleGetProject(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (projectData._id)
          projectData._id = new mongoose_1.default.Types.ObjectId(
            projectData._id
          );
        ...
        if (project) {
          ...
          return res
            .status(400)
            .send((0, errorUtils_1.customeError)("get_project_error", 400));
        }
      } catch (error) {
        ...
        if (tasks) {
          ...
          if (project) {
            ...
            return res
              .status(200)
              .send(
                (0, successMsg_1.successMsg)("projects_and_tasks_deleted", 200)
              );
          } else {
            return res
              .status(400)
              .send(
                (0, errorUtils_1.customeError)("delete_project_error", 400)
              );
          }
        } else {
          return res
      ...
      try {
        ...
        if (!sortBy)
          return res
            .status(400)
            .send(
              (0, errorUtils_1.customeError)("sort_projects_params_empty", 400)
            );
      ...
      try {
        ...
        if (projects) return res.status(200).send({ result: projects });
          ...
          return res
            .status(400)
            .send(
              (0, errorUtils_1.customeError)(
                "filter_projects_result_empty",
                400
              )
            );
      } catch (error) {
      ...
      try {
        ...
        if (result) return res.status(200).send(result);
          ...
          return res
            .status(400)
            .send(
              (0, errorUtils_1.customeError)("search_Proejcts_result_null", 400)
            );
      } catch (error) {
        logger_1.default.error({ filterProjectsError: error });
        return res
