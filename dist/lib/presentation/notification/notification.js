        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (decoded === null || decoded === void 0 ? void 0 : decoded.id) {
                    let notifications = yield _super.__sendNotifications.call(this, decoded === null || decoded === void 0 ? void 0 : decoded.id, parseInt(req.params.current), parseInt(req.params.limit));
    ...
    static updateNotified(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let decoded = yield (0, auth_1.jwtVerify)(req.header("authorization"));
                if (decoded === null || decoded === void 0 ? void 0 : decoded.id) {
                    let updateUnNotified = yield _super.__updateUnotified.call(this, decoded === null || decoded === void 0 ? void 0 : decoded.id);
    ...
    static getUnNotified(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let decoded = yield (0, auth_1.jwtVerify)(req.header("authorization"));
                if (decoded === null || decoded === void 0 ? void 0 : decoded.id) {
                    let notified = yield _super.__getUnNotified.call(this, decoded === null || decoded === void 0 ? void 0 : decoded.id);
