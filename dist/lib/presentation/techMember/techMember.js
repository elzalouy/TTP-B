  ...
  static handleCreatMember(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (
          (member === null || member === void 0 ? void 0 : member.status) ===
          200
        ) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (member) {
          return res
            .status(200)
            .send((0, successMsg_1.successMsg)("tec_member_updated", 200));
        } else {
          return res
            .status(400)
            .send(
              (0, errorUtils_1.customeError)("tec_member_update_error", 400)
            );
        }
      } catch (error) {
        logger_1.default.error({ handleGetBoards: error });
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (members) {
          ...
          return res
            .status(400)
            .send((0, errorUtils_1.customeError)("tec_member_get_error", 400));
        }
      } catch (error) {
        logger_1.default.error({ handleGetBoards: error });
        return res
      ...
      try {
        ...
        if (members) {
          ...
          return res
            .status(400)
            .send(
              (0, errorUtils_1.customeError)("tech_member_delete_error", 400)
            );
        }
      } catch (error) {
        logger_1.default.error({ handleGetBoards: error });
