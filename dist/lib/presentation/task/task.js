...
const TaskReq = class TaskReq extends task_1.default {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (task) {
          ...
          return res
            .status(400)
            .send((0, errorUtils_1.customeError)("create_task_error", 400));
        }
      } catch (error) {
  ...
  static handleUpdateCard(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        taskQueue_1.updateTaskQueue.push((cb) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            if (TaskData.deleteFiles)
              deleteFiles = TaskData.deleteFiles
                ? JSON.parse(
                    TaskData === null || TaskData === void 0
                      ? void 0
                      : TaskData.deleteFiles
                  )
                : [];
        ...
        return res
          .status(400)
          .send((0, errorUtils_1.customeError)("update_task_error", 400));
      }
    });
  }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (tasks) return res.status(200).send(tasks);
          ...
          res
            .status(400)
            .send((0, errorUtils_1.customeError)("get_tasks_error", 400));
      } catch (error) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (decoded === null || decoded === void 0 ? void 0 : decoded.user) {
          ...
          let task = yield _super.moveTaskOnTrello.call(
            this,
            cardId,
            listId,
            status,
          ...
          if (task === null || task === void 0 ? void 0 : task.error)
            return res
              .status(400)
              .send(task === null || task === void 0 ? void 0 : task.message);
          return res.send(task);
        }
      } catch (error) {
  ...
  static handleDeleteTasksByProjectId(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (
          deleteResult === null || deleteResult === void 0
            ? void 0
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (deleteResult) return res.status(200).send(deleteResult);
          ...
          res
            .status(400)
            .send((0, errorUtils_1.customeError)("delete_task_error", 400));
      } catch (error) {
      ...
      try {
        ...
        let attachmentId =
          (_b = req.query) === null || _b === void 0
            ? void 0
            : _b.attachmentId.toString();
        if (cardId && attachmentId) {
          let result = yield _super.downloadAttachment.call(
            this,
            cardId,
            attachmentId
          );
        ...
        } else res.status(400).send("Request values missed cardId and AttachmentId");
      } catch (error) {
  ...
  static hanldeEditTasksProjectId(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (ids && projectId) {
          let response = yield _super.__editTasksProjectId.call(
            this,
            ids,
            projectId
          );
