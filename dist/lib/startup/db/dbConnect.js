...
exports.createTTPCreativeMainBoard =
  exports.initializeTTPTasks =
  exports.initializeTrelloBoards =
  exports.initializeTrelloMembers =
    void 0;
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userInfo) {
      let passwordHash = yield (0, auth_1.hashBassword)(
        config_1.default.get("superAdminPassword")
      );
      const data = {
...
const initializeTrelloBoards = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      boardsIds =
        allBoards === null || allBoards === void 0
          ? void 0
          : allBoards.map((item) => item.id);
      allDepartments = yield Department_1.default.find({});
      depsIds =
        allDepartments === null || allDepartments === void 0
          ? void 0
          : allDepartments.map((item) => item.boardId);
      ...
      notExistedOnTrello = yield Promise.all(
        lodash_1.default.flatMap(notExistedOnTrello, (item) =>
          __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
            let board = yield trello_1.default.createNewBoard(
              item.name,
              item.color
            );
            ...
            item.lists = yield Promise.all(
              (_a = item.lists) === null || _a === void 0
                ? void 0
                : _a.map((list) =>
                    __awaiter(void 0, void 0, void 0, function* () {
                      let listInBoard = yield trello_1.default.addListToBoard(
                        board.id,
                        list.name
                      );
            ...
            item.teams = yield Promise.all(
              (_b = item.teams) === null || _b === void 0
                ? void 0
                : _b.map((team) =>
                    __awaiter(void 0, void 0, void 0, function* () {
                      let teamInBoard = yield trello_1.default.addListToBoard(
                        board.id,
                        team.name
                      );
      ...
      allDepartments =
        allDepartments === null || allDepartments === void 0
          ...
          : allDepartments.map((item) => {
              let index = lodash_1.default.findIndex(notExistedOnTrello, {
      ...
      let newDeps = yield Promise.all(
        notExistedOnTTP === null || notExistedOnTTP === void 0
          ? void 0
              ...
              __awaiter(void 0, void 0, void 0, function* () {
                ...
                listTypes =
                  item.name === config_1.default.get("CreativeBoard")
                    ? Department_2.CreativeListTypes
                    : Department_2.ListTypes;
                let teams = lists.filter(
                  (item) => !listTypes.includes(item.name)
                );
                return new Department_1.default({
                  boardId: item.id,
                  name: item.name,
                  color: "blue",
                  lists: yield Promise.all(
                    listTypes === null || listTypes === void 0
                      ? void 0
                      : listTypes.map((listName) =>
                          __awaiter(void 0, void 0, void 0, function* () {
                            var _c;
                            listExisted =
                              (_c =
                                item === null || item === void 0
                                  ? void 0
                                  : item.lists) === null || _c === void 0
                                ? void 0
                                : _c.find((list) => listName === list.name);
                            return {
                              name: listName,
                              listId:
                                listExisted &&
                                (listExisted === null || listExisted === void 0
                                  ? void 0
                                  : listExisted.id)
                                  ? listExisted.id
                                  : yield trello_1.default
                                      .addListToBoard(item.id, listName)
                                      .then((res) => {
                                        return res.id;
                                      }),
                            };
      ...
      intersection = yield Promise.all(
        intersection === null || intersection === void 0
          ...
          : intersection.map((item) =>
              __awaiter(void 0, void 0, void 0, function* () {
                ...
                board.lists = yield trello_1.default.__getBoardLists(
                  item.boardId
                );
                listTypes =
                  item.name === config_1.default.get("CreativeBoard")
                          ...
                          let listExisted =
                            (_f =
                              board === null || board === void 0
                                ? void 0
                                : board.lists) === null || _f === void 0
                              ? void 0
                              : _f.find((list) => listName === list.name);
                          return {
                            name: listName,
                            listId:
                              listExisted &&
                              (listExisted === null || listExisted === void 0
                                ...
                                ? listExisted.id
                                : yield trello_1.default
                                    .addListToBoard(item.boardId, listName)
                                    .then((res) => {
                                      return res.id;
                                    }),
                          };
                ...
                item.teams =
                  (_e =
                    (_d = board.lists) === null || _d === void 0
                      ? void 0
                      : _d.filter((item) => !listTypes.includes(item.name))) ===
                    null || _e === void 0
                    ? void 0
                    : _e.map((item) => {
                        return {
      ...
      let updateTeams = lodash_1.default.flattenDeep(
        allDepartments === null || allDepartments === void 0
          ? void 0
          : allDepartments.map((item) => {
              var _a;
              return (_a = item.teams) === null || _a === void 0
                ? void 0
                : _a.map((team) => {
                    return {
                      updateOne: {
      ...
      let updateLists = lodash_1.default.flattenDeep(
        allDepartments === null || allDepartments === void 0
          ? void 0
          : allDepartments.map((item) => {
              var _a;
              return (_a = item.lists) === null || _a === void 0
                ? void 0
                : _a.map((list) => {
                    return {
                      updateOne: {
      ...
      yield allDepartments.forEach((item) =>
        __awaiter(void 0, void 0, void 0, function* () {
          return yield trello_1.default.__addWebHook(
            item.boardId,
...
const initializeTTPTasks = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      boards = yield Promise.all(
        boards === null || boards === void 0
          ? void 0
          : boards.map((item) =>
              __awaiter(void 0, void 0, void 0, function* () {
                let lists = yield trello_1.default.__getBoardLists(item.id);
      ...
      creativeBoard =
        boards === null || boards === void 0
          ? void 0
          : boards.find(
              (item) => item.name === config_1.default.get("CreativeBoard")
            );
      tasks = yield Task_1.default.find({});
      creativeDepartment = yield Department_1.default.findOne({
        boardId:
          creativeBoard === null || creativeBoard === void 0
            ? void 0
            : creativeBoard.id,
      });
      projectsListId =
        (_h =
          (_g =
            creativeDepartment === null || creativeDepartment === void 0
              ? void 0
              : creativeDepartment.lists) === null || _g === void 0
            ? void 0
            : _g.find((item) => item.name === "projects")) === null ||
        _h === void 0
          ? void 0
          : _h._id;
      let newCards = yield Promise.all(
        boards === null || boards === void 0
          ? void 0
          : boards.map((item) =>
              __awaiter(void 0, void 0, void 0, function* () {
                var _j;
                let boardCards = yield trello_1.default.__getCardsInBoard(
                  item.id
                );
                if (item.name === config_1.default.get("CreativeBoard")) {
                  let list =
                    (_j =
                      item === null || item === void 0
                        ? void 0
                        : item.lists) === null || _j === void 0
                      ? void 0
                      : _j.find((l) => l.name === "projects").id;
                  boardCards = boardCards.filter(
                    (item) => item.idList !== list
                  );
                }
                return boardCards;
              })
        ...
        cards === null || cards === void 0
          ...
          : cards.map((item) =>
              __awaiter(void 0, void 0, void 0, function* () {
                ...
                item.attachments =
                  attachments !== null && attachments !== void 0
                    ? attachments
                    : [];
                return item;
              })
          ...
          : intersection.map((item) =>
              __awaiter(void 0, void 0, void 0, function* () {
                ...
                let card =
                  cards === null || cards === void 0
                    ? void 0
                    : cards.find((c) => c.id === item.cardId);
                let dep =
                  departments === null || departments === void 0
                    ? void 0
                    : departments.find((d) => d.boardId === card.idBoard);
                let status =
                  (_k = dep.lists) === null || _k === void 0
                    ? void 0
                    : _k.find((list) => list.listId === card.idList);
                let team =
                  (_l = dep.teams) === null || _l === void 0
                    ? void 0
                    : _l.find((team) => team.listId === card.idList);
                let replacement = new Task_1.default({
                  ...
                  teamListId:
                    (_p =
                      team === null || team === void 0
                        ? void 0
                        : team.listId) !== null && _p !== void 0
                      ? _p
                      : item === null || item === void 0
                      ? void 0
                      : item.teamListId,
                  ...
                  attachedFiles:
                    (_r =
                      card === null || card === void 0
                        ? void 0
                        : card.attachments) === null || _r === void 0
                      ? void 0
                      : _r.map((item) => {
                          return {
                            name: item.fileName,
        ...
        tasks === null || tasks === void 0
          ...
          : tasks.map((item) => {
              let index =
                intersection === null || intersection === void 0
                  ? void 0
                  : intersection.findIndex((task) => task._id === item._id);
              return index >= 0 ? intersection[index] : item;
            });
      // not Existed on TTP > create it on TTP
      let newTasks = [
        ...(notExistedOnTTP === null || notExistedOnTTP === void 0
          ...
          : notExistedOnTTP.map((item) => {
              ...
              let dep =
                departments === null || departments === void 0
                  ? void 0
                  : departments.find((d) => d.boardId === item.idBoard);
              let status =
                (_a = dep === null || dep === void 0 ? void 0 : dep.lists) ===
                  null || _a === void 0
                  ? void 0
                  : _a.find((list) => list.listId === item.idList);
              let team =
                (_b = dep === null || dep === void 0 ? void 0 : dep.teams) ===
                  null || _b === void 0
                  ? void 0
                  : _b.find((team) => team.listId === item.idList);
              let task = new Task_1.default({
                ...
                cardId: item.id,
                description:
                  (_f = item.desc) !== null && _f !== void 0 ? _f : "",
                ...
                attachedFiles:
                  item.attachments.length > 0
                    ? (_g =
                        item === null || item === void 0
                          ? void 0
                          : item.attachments) === null || _g === void 0
                      ? void 0
                      : _g.map((item) => {
                          return {
                            name: item.fileName,
      ...
      // not Existed on Trello > create it on Trello
      notExistedOnTrello = yield Promise.all(
        notExistedOnTrello === null || notExistedOnTrello === void 0
          ? void 0
          : notExistedOnTrello.map((item) =>
              __awaiter(void 0, void 0, void 0, function* () {
                var _s;
                let board =
                  boards === null || boards === void 0
      ...
      tasks =
        tasks === null || tasks === void 0
          ? void 0
          : tasks.map((item) => {
              let index = notExistedOnTrello.findIndex(
                (i) => i._id === item._id
              );
              return index >= 0 ? notExistedOnTrello[index] : item;
            });
      let update = [
        ...(newTasks === null || newTasks === void 0
          ? void 0
          : newTasks.map((item) => {
              return {
                insertOne: {
      ...
      yield tasks.forEach((item) =>
        __awaiter(void 0, void 0, void 0, function* () {
          yield trello_1.default.__addWebHook(
            item.cardId,
            "trelloWebhookUrlTask"
          );
        })
...
const createTTPCreativeMainBoard = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _t;
    try {
      let dep = {
      ...
      let listOfProjects =
        department &&
        (department === null || department === void 0
          ? void 0
          : department.lists) &&
        ((_t =
          department === null || department === void 0
            ? void 0
            : department.lists) === null || _t === void 0
          ? void 0
          : _t.find((item) => item.name === "projects"));
      if (department && listOfProjects) {
        (0, department_actions_queue_1.createProjectsCardsInCreativeBoard)(
          department
        );
      }
    } catch (error) {
