  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      intersection = allDepartments.filter((item) =>
        boardsIds === null || boardsIds === void 0
          ? void 0
        ...
        intersection === null || intersection === void 0
          ...
          : intersection.map((item) =>
              __awaiter(void 0, void 0, void 0, function* () {
                ...
                item.teams =
                  (_e =
                    (_d = board.lists) === null || _d === void 0
                      ...
                      : _d.filter(
                          (item) =>
                            !listTypes.includes(item.name) &&
                            !sideListsIds.includes(item.id)
                        )) === null || _e === void 0
                    ? void 0
                    : _e.map((item) => {
                        return {
                ...
                item.sideLists = yield Promise.all(
                  item.sideLists.map((sideI) =>
                    __awaiter(void 0, void 0, void 0, function* () {
                      ...
                      return {
                        ...
                        listId:
                          ...
                          (listExisted === null || listExisted === void 0
                            ...
                            : listExisted.id)
                            ? listExisted.id
                            : yield trello_1.default.addListToBoard(
                                item.boardId,
                                sideI.name
                              ),
                      };
      ...
      let updateSideLists = lodash_1.default.flattenDeep(
        allDepartments.map((item) => {
      ...
      allDepartments.forEach((item) =>
        __awaiter(void 0, void 0, void 0, function* () {
          return trello_1.default.__addWebHook(
            item.boardId,
          ...
          : intersection.map((item) =>
              __awaiter(void 0, void 0, void 0, function* () {
                ...
                let replacement = new Task_1.default({
                  ...
                  description:
                    (_m =
                      (_l = card.desc) !== null && _l !== void 0
                        ? _l
                        : item.description) !== null && _m !== void 0
                      ? _m
                      : "",
                  start: card.start,
                  ...
                  attachedFiles:
                    ((_p =
                      card === null || card === void 0
                        ? void 0
                        : card.attachments) === null || _p === void 0
                      ? void 0
                      : _p.length) > 0
                      ? (_q =
                          card === null || card === void 0
                            ? void 0
                            : card.attachments) === null || _q === void 0
                        ? void 0
                        : _q.map((item) => {
                            return {
                              name: item.fileName,
        ...
        ...(notExistedOnTTP === null || notExistedOnTTP === void 0
          ...
          : notExistedOnTTP.map((item) => {
              ...
              let task = new Task_1.default({
                ...
                cardId: item.id,
                description:
                  (_d = item.desc) !== null && _d !== void 0 ? _d : "",
                ...
                attachedFiles: (
                  (_e =
                    item === null || item === void 0
                      ? void 0
                      : item.attachments) === null || _e === void 0
                    ? void 0
                    : _e.length
                )
                  ? (_f =
                      item === null || item === void 0
                        ? void 0
                        : item.attachments) === null || _f === void 0
                    ? void 0
                    : _f.map((item) => {
                        return {
                          name: item.fileName,
