...
const mongoDB = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (department === null) {
            ...
            let result = yield department_1.default.createDepartment(dep);
            let listOfProjects = result.lists.find((item) => item.name.toLocaleLowerCase() === "projects");
            if (result && (result === null || result === void 0 ? void 0 : result._id)) {
                let projects = yield project_1.default.getProject({});
                projects.forEach((item) => {
                    trello_1.default.__createProject(listOfProjects.listId, item);
                });
            }
        }
    }
