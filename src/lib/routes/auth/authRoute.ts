...
const router = Router()
const {SIGN_IN_USER,FORGET_PASSWORD,UPDATE_PASSWORD,LOGOUT_USER} = apiRoute
const {handleSignInUser,handleUserForgetPassword,handleUpdateUserPassword,handleLogoutUser} = AuthReq
