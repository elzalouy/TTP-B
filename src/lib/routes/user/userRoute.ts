...
const router = Router()
const {CREATE_USER,UPDATE_USER,UPDATE_PASSWORD,DELETE_USER,GET_USERS,GET_USER,RESET_PASSWORD} = apiRoute
const {handleCreatUser,handleUpdateUser,handleUpdatePassword,handleDeleteUser,handleGetUserPmOrSA,handleGetUserInfo,handleResetPassword} = UserReq
